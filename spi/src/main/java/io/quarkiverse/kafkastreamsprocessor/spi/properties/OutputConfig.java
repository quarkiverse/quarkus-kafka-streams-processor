...
public interface OutputConfig {
    ...
    /**
     * Allows to automatically insert a timestamp in the CloudEvent when building the outgoing message, if the time was
     * not explicitly set. It is used only if {@link OutputConfig#isCloudEvent()} is <code>true</code>.
     *
