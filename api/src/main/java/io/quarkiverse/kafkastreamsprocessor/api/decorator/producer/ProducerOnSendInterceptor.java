...
/**
 * Interface to extend to by able to decorate the production of the response message to the outgoing topic after the payload has
 * been serialized to <code>byte[]</code>.
 */
